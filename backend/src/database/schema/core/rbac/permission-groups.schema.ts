...
import { type AnyPgColumn, bigint, pgTable, text, varchar } from 'drizzle-orm/pg-core';
...
export const permissionGroupsRelations = relations(permissionGroupsTable, ({ one }) => ({

...
import { type AnyPgColumn, bigint, boolean, index, pgTable, timestamp } from 'drizzle-orm/pg-core';
...
export const subscriptionsTable = pgTable(
   'subscriptions',
   {
      ...
      currentPeriodEnd: timestamp('current_period_end', { mode: 'date', withTimezone: true }).notNull(),

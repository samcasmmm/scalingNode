...
import { type AnyPgColumn, index, jsonb, pgTable, uniqueIndex, varchar } from 'drizzle-orm/pg-core';
import { tenantStatusEnum } from '@/database/schema/core/_core.enum.js';
import { auditActorColumns, baseColumns, imageBaseColumns, versionColumn } from '@/database/schema/core/_shared.columns.js';
import {
   usersTable,
   organizationsTable,
   businessUnitsTable,

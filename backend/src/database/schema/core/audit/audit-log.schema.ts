...
import { type AnyPgColumn, bigint, index, jsonb, pgTable, varchar } from 'drizzle-orm/pg-core';
import { auditActorColumns, baseColumns, versionColumn } from '@/database/schema/core/_shared.columns.js';
